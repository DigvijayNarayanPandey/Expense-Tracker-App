...
const SectionLabel = ({ children, center }) => (
  <div
    className={`flex items-center gap-2 mb-3 ${center ? "justify-center" : ""}`}
  >
...
const features = [
  {
    ...
    bg: "bg-teal-50",
    desc: "Real-time overview of income, expenses, and net balance all in one clean, focused view.",
  },
  {
    title: "Expense Tracking",
    bg: "bg-amber-50",
    desc: "Log every expense with categories, icons, and notes. Filter by date, type, or amount instantly.",
  },
  {
    title: "Income Management",
    bg: "bg-green-50",
    desc: "Track salary, freelance, and side hustles separately. Understand your total earning capacity.",
  },
  {
    title: "Visual Analytics",
    bg: "bg-sky-50",
    desc: "Recharts-powered graphs showing spending trends, category breakdowns, and monthly comparisons.",
  },
  {
    title: "Secure Auth",
    bg: "bg-stone-100",
    desc: "JWT-based login with encrypted passwords. Your private data stays private no exceptions.",
  },
  {
    title: "Export to Excel",
    bg: "bg-rose-50",
    desc: "Download your full history as a spreadsheet. Perfect for tax filing, audits, or personal review.",
  },
];
...
const steps = [
  {
    ...
    body: "Sign up with your name and email. JWT authentication keeps your session and data secure from day one.",
  },
  {
    n: "2",
    title: "Log income & expenses",
    body: "Add transactions with categories and notes. Upload a profile picture too — it only takes a moment.",
  },
  {
    n: "3",
    title: "Analyse and improve",
    body: "Let the dashboard do the thinking. Spot patterns, trim waste, and watch your savings grow month by month.",
  },
];
...
const progressItems = [
  ...
  { label: "🚗 Transport", pct: 18, color: "bg-cyan-500" },
...
const testimonials = [
  {
    ...
    bg: "bg-teal-400",
    quote:
      "This completely changed how I handle money. The charts make everything obvious — I cut my food spending by 20% just by seeing it.",
  },
  {
    initials: "PS",
    name: "Priya Sharma",
    ...
    bg: "bg-amber-400",
    quote:
      "So clean and fast. Adding expenses takes seconds. The Excel export saved me hours during tax season — I use it every single day.",
  },
  {
    initials: "AK",
    name: "Arjun Kumar",
    ...
    bg: "bg-sky-500",
    quote:
      "Finally a finance app that feels human. Simple, beautiful, and my data actually feels secure. Highly recommend it.",
  },
];
...
export default function LandingPage() {
  ...
  return (
    <>
      <SeoMeta
        title="Expense Tracker India - Track Income, Expenses and Budget Better"
        description="Track daily income and expenses, monitor trends, and build better money habits with Expense Tracker for users across India."
        path="/"
      ...
      <div className="bg-stone-50 text-stone-900 font-sans overflow-x-hidden">
        ...
        <nav
          className="fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between
                            px-6 sm:px-10 bg-stone-50/90 backdrop-blur-md border-b border-stone-200"
        >
          <Link
            to="/"
            className="flex items-center gap-2 font-bold text-lg text-stone-900 no-underline"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="px-4 py-2 rounded-lg text-sm font-semibold bg-teal-700 text-white
                                   hover:bg-teal-800 transition-all duration-150 no-underline shadow-sm"
            >
              Get started free
            </Link>
          </div>
          ...
          <div className="pt-28 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <a
                  href="#how"
                  className="group px-2 flex items-center gap-1.5 text-sm font-medium
              ...
              <div className="mt-10 flex items-center gap-3">
                <div className="flex">
                  {[
                    { label: "RA", cls: "bg-teal-400" },
                    { label: "PS", cls: "bg-amber-400" },
                    { label: "AK", cls: "bg-sky-500" },
                  ].map((av, idx) => (
                    <span
                      key={idx}
                      className={`w-7 h-7 rounded-full border-2 border-stone-50
                                                    flex items-center justify-center
                                                    font-bold text-white ${av.cls}
                                                    ${idx !== 2 ? "-mr-2" : ""}`}
                      style={{ fontSize: "10px" }}
                    >
                      {av.label}
                ...
                <p className="text-xs text-stone-400 font-medium pl-2">
                  <strong className="text-stone-500">10,000+</strong> people
            ...
            <div className="hidden lg:block">
              <div
                className="bg-white rounded-2xl border border-stone-300
                                        shadow-2xl shadow-stone-900/10 overflow-hidden"
              >
                {/* Browser bar */}
                <div className="bg-stone-200 border-b border-stone-300 px-4 py-2.5 flex items-center gap-2">
                  ...
                  <span
                    className="flex-1 mx-3 bg-white border border-stone-200
                                                 rounded-md px-3 py-1 text-xs text-stone-500 font-mono"
                  >
                ...
                <div className="p-5">
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[
                      ...
                      <div
                        key={c.label}
                        className={`${c.bg} rounded-xl p-3 border border-stone-200`}
                      >
                        <p className="text-[10px] font-semibold uppercase tracking-widest text-stone-500 mb-1">
                          {c.label}
                        </p>
                        <p className={`text-base font-bold ${c.cls}`}>
                          {c.val}
                        </p>
                        <p className={`text-[10px] mt-0.5 font-medium ${c.dc}`}>
                          {c.delta}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="border border-stone-200 rounded-xl p-3 mb-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex gap-2">
                        <span className="text-[10px] font-semibold bg-emerald-100 text-emerald-600 px-2 py-0.5 rounded">
                          Income
                        </span>
                        <span className="text-[10px] font-semibold bg-red-100 text-red-500 px-2 py-0.5 rounded">
                          Expense
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-2 mt-2">
                      {bars.map((b) => (
                        <span
                          key={b.month}
                          className="flex-1 text-center text-[9px] text-stone-400 font-medium"
                        >
                          {b.month}
                        </span>
                      ))}
                  ...
                  <div className="flex flex-col gap-1.5">
                    {transactions.map((t) => (
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <span
                            className="w-7 h-7 rounded-lg bg-stone-50 flex items-center
                        ...
                        <span
                          className={`text-xs font-bold ${t.neg ? "text-red-500" : "text-emerald-600"}`}
                        >
                          {t.amt}
                        </span>
                      </div>
        ...
        <div className="bg-white border-y border-stone-200">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-2 md:grid-cols-4">
            {[
              ...
              <div
                key={s.l}
                className={`py-8 px-4 text-center ${i !== 3 ? "border-r border-stone-100" : ""}`}
              >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight">
                  Everything your wallet
                  <br className="hidden sm:block" /> has been waiting for.
                </h2>
              </div>
              <p className="text-sm leading-relaxed text-stone-500 max-w-xs md:max-w-sm md:text-right">
                Built with the MERN stack fast, secure, and designed to make
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {features.map((f) => (
                <div
                  key={f.title}
                  className="group border border-stone-200 rounded-2xl p-6 bg-stone-50
        ...
        <section id="how" className="bg-stone-50 py-20 px-6 sm:px-10">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex flex-col gap-6">
                  {steps.map((s) => (
                    <div key={s.n} className="flex gap-4 items-start">
                      <div
                        className="w-9 h-9 rounded-xl border-2 border-teal-600 text-teal-700
              ...
              <div className="bg-white border border-stone-200 rounded-2xl p-6 shadow-md shadow-stone-900/8">
                ...
                <div className="border-t border-stone-100 pt-5">
                  <div className="grid grid-cols-3 text-center gap-2">
                    {[
                      ...
                      <div key={m.lbl}>
                        <p className={`text-lg font-extrabold ${m.cls}`}>
                          {m.val}
                        </p>
        ...
        {/* ══ TESTIMONIALS ═════════════════════════════════════════ */}
        <section id="testimonials" className="bg-white py-20 px-6 sm:px-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-3 text-sm text-stone-500 max-w-sm mx-auto leading-relaxed">
                Real reviews from real people managing their money better.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {testimonials.map((t) => (
                ...
                >
                  ...
                  <p className="text-sm text-stone-500 leading-relaxed italic flex-1">
                    "{t.quote}"
                  </p>
                  <div className="flex items-center gap-3">
                    <span
                      className={`w-9 h-9 rounded-full ${t.bg} flex items-center
        ...
        <section
          id="cta"
          className="bg-stone-900 py-20 px-6 sm:px-10 text-center"
        >
          <div className="max-w-xl mx-auto">
            ...
            <p className="mt-4 text-sm leading-relaxed text-stone-400 max-w-sm mx-auto">
              Join thousands of people who finally understand their money. Free
              to use, no card needed.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
              ...
              <div className="col-span-2 md:col-span-1">
                <Link
                  to="/"
                  className="flex items-center gap-2 font-bold text-base text-white no-underline mb-3"
                >
                  <span className="w-8 h-8 rounded-xl bg-teal-700 flex items-center justify-center text-sm text-white">
                    ₹
                  </span>
                  Expense Tracker
                </Link>
                <p className="text-xs leading-relaxed text-stone-500 max-w-[200px]">
                  A modern expense tracker. Built to help you spend smarter and
