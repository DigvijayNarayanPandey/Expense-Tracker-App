...
const features = [
    { title: "Smart Dashboard", bg: "bg-teal-50", desc: "Real-time overview of income, expenses, and net balance all in one clean, focused view." },
    { title: "Expense Tracking", bg: "bg-amber-50", desc: "Log every expense with categories, icons, and notes. Filter by date, type, or amount instantly." },
    { title: "Income Management", bg: "bg-green-50", desc: "Track salary, freelance, and side hustles separately. Understand your total earning capacity." },
    { title: "Visual Analytics", bg: "bg-sky-50", desc: "Recharts-powered graphs showing spending trends, category breakdowns, and monthly comparisons." },
    { title: "Secure Auth", bg: "bg-stone-100", desc: "JWT-based login with encrypted passwords. Your private data stays private no exceptions." },
    { title: "Export to Excel", bg: "bg-rose-50", desc: "Download your full history as a spreadsheet. Perfect for tax filing, audits, or personal review." },
];
...
const testimonials = [
    { initials: "RA", name: "Rahul Agarwal", role: "Software Engineer · Delhi", bg: "bg-teal-400", quote: "This completely changed how I handle money. The charts make everything obvious — I cut my food spending by 20% just by seeing it." },
    { initials: "PS", name: "Priya Sharma", role: "Freelancer · Bangalore", bg: "bg-amber-400", quote: "So clean and fast. Adding expenses takes seconds. The Excel export saved me hours during tax season — I use it every single day." },
    { initials: "AK", name: "Arjun Kumar", role: "MBA Student · Mumbai", bg: "bg-sky-500", quote: "Finally a finance app that feels human. Simple, beautiful, and my data actually feels secure. Highly recommend it." },
];
                    ...
                    <div className="hidden lg:block">
                        <div className="bg-white rounded-2xl border border-stone-300
                            ...
                            <div className="bg-stone-200 border-b border-stone-300 px-4 py-2.5 flex items-center gap-2">
                                ...
                                <span className="flex-1 mx-3 bg-white border border-stone-200
                                ...
                                <div className="grid grid-cols-3 gap-3 mb-4">
                                    {[
                                        ...
                                        <div key={c.label} className={`${c.bg} rounded-xl p-3 border border-stone-200`}>
                                            ...
                                            <p className={`text-[10px] mt-0.5 font-medium ${c.dc}`}>{c.delta}</p>
                                        </div>
                                    ))}
                                </div>
            ...
            <div className="bg-white border-y border-stone-200">
                <div className="max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-2 md:grid-cols-4">
                    {[
                        ...
                        >
                            <p className="text-3xl font-extrabold text-teal-700 tracking-tight">{s.n}</p>
            ...
            <section id="cta" className="bg-stone-900 py-20 px-6 sm:px-10 text-center">
                <div className="max-w-xl mx-auto">
                    ...
                    <p className="mt-4 text-sm leading-relaxed text-stone-400 max-w-sm mx-auto">
                        Join thousands of people who finally understand their money. Free to use, no card needed.
                    </p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <Link to="/" className="flex items-center gap-2 font-bold text-base text-white no-underline mb-3">
                        ...
                        {/* Product */}
                        <div>
                            <h5 className="text-[10px] font-bold uppercase tracking-widest text-stone-500 mb-4">Product</h5>
                            <div className="flex flex-col gap-2">
                                {[["#features", "Features"], ["#how", "How it works"], ["#testimonials", "Reviews"]].map(([href, label]) => (
                                    <a key={label} href={href} className="text-xs text-stone-500 hover:text-white transition-colors no-underline">
                                        {label}
                                    </a>
                                ))}
                            </div>
                        ...
                        {/* Account */}
                        <div>
                            <h5 className="text-[10px] font-bold uppercase tracking-widest text-stone-500 mb-4">Account</h5>
                            <div className="flex flex-col gap-2">
                                {[
                                    ["/login", "Login"],
                                    ["/signup", "Sign Up"],
                                    [user || localStorage.getItem("token") ? "/dashboard" : "/login", "Dashboard"],
                                ].map(([href, label]) => (
                                    <a key={label} href={href} className="text-xs text-stone-500 hover:text-white transition-colors no-underline">
                                        {label}
                                    </a>
                        ...
                        {/* Legal */}
                        <div>
                            <h5 className="text-[10px] font-bold uppercase tracking-widest text-stone-500 mb-4">Legal</h5>
                            <div className="flex flex-col gap-2">
